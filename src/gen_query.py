...
PATH_GENERAL_PROMPT_GEN_QUERY = 'B:\\TT\\Project - information extraction\\data\\general\\general_prompt_gen_query.txt'

with open(PATH_GENERAL_PROMPT_GEN_QUERY, 'r', encoding='utf-8') as file:
...
PATH_QUERY = 'B:\\TT\\Project - information extraction\\data\\query\\query.txt'
PATH_QUERY_TEST = 'B:\\TT\\Project - information extraction\\data\\query\\query_test.txt'
...
for i in range(number_of_examples):
    ...
    prompt = f'Hãy đưa ra câu truy vấn với mô tả duy nhất như sau "{rules[i_rand]}". Đưa ra câu trả lời với định dạng: Điều:...\nTruy vấn:...'
    # Interact chatgpt
    ...
    #time.sleep(30)
    #btn_answer = driver.find_elements(By.TAG_NAME, "button")[0]
    ...
    with open(PATH_QUERY_TEST, 'a', encoding='utf-8') as file:
        file.write(result + '\n')
